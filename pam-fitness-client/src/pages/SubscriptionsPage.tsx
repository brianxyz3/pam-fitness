...
const SubscriptionsPage = () => {
  return (
    <main className='pt-32 overflow-y-auto font-lexand px-6 md:px-10 lg:px-20 xl:px-40 flex flex-1 justify-center py-10'>
      <div className="flex flex-col max-w-screen-xl w-full gap-12">
      <section className="flex flex-col gap-8 items-center">
        <h1 className="text-white text-4xl md:text-5xl font-bold leading-tight tracking-tight text-center">Choose Your Perfect Plan</h1>
