...
const JoinUs = () => {
  return (
    <section className='flex flex-wrap justify-evenly md:justify-between mx-10 mb-10 gap-y-10'>
        <div className='w-11/12 md:w-[40%] lg:w-[32%] p-7 text-center flex flex-col justify-between bg-zinc-900/80 rounded-3xl'>
            ...
            <div className='w-11/12 mx-auto bg-red-600 flex text-black justify-between items-center gap-1 sm:gap-2 text-nowrap text-sm p-1 rounded-3xl'>
                <p className='w-4/5 ms-auto font-bold block'>JOIN OUR TEAM</p>
                <IconBtn style='size-6 sm:size-8 bg-black'>
                    <BsArrowRight className='-rotate-45 size-3 sm:size-4 fill-red-600'/>
                </IconBtn>
            </div>
        </div>
